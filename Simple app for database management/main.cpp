...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        while(1) { // da se nemora pokretati nakon svakog izvrsenog menia
            cout << endl << "1. Proizvodi" << endl; //ok
            ...
            cout << "- - - - - - - - - - - - - -" << endl;
            cout << "8. !Ostale relacije!" << endl << endl;//ok
            ...
            switch (selekcija) {
                case 1: {
                    ...
                    cout << "~ ~ ~ " << endl;
                    cout << "0. Natrag na glavni izbornik" << endl << endl;
                    cout << "Meni:";
                    cin >> podM;
                    cout << endl;

                    if (podM == 1) { //Pregled OK
                        ...
                        while (cmd.FetchNext()) { //prikpuljanje redova sta izbaci baza
                    ...
                    else if (podM == 4) { //Zalihe proizvoda OK
                        string plt, plttmp;
                        int pID, posID;
                    ...
                    else if (podM == 5) { //Proizvodi koji nisu vraceni OK
                        TextTable t('-', '|', '+');
                ...
                case 2: {
                    ...
                    else if (podM == 3) { //Vracanje igre OK
                        string plt, plttmp;
                        int pID, posID, racID;
                    ...
                    else if (podM == 4) { //Broj aktivnih kupaca OK
                ...
                case 3: { //Poslovnice OK
                    ...
                    else if (podM == 2){ //Posudeno po poslovnici
                        TextTable t('-', '|', '+');
                    ...
                    else if (podM == 3){ //Prodaja po poslovnici
                        TextTable t('-', '|', '+');
                ...
                case 4: {
                    ...
                    else if (podM == 3) { //Informacije zaposlenika OK
                        TextTable t('-', '|', '+');
                        int zID;
                    ...
                    else if (podM == 4) { //Promet zaposlenika OK
                        TextTable t('-', '|', '+');
                        int zID;
                    ...
                    else if (podM == 5) { //Rent zaposlenika OK
                        TextTable t('-', '|', '+');
                        int zID;
                    ...
                    else if (podM == 6) { //Place zaposlenika ok
                        string pswdTmp;
                        cout << "Login sifra: ";
                        cin >> pswdTmp;
                    ...
                    else if (podM == 7) { //Korisnicko ime OK
                        string pswdTmp;
                        cout << "Login sifra: ";
                        cin >> pswdTmp;
                ...
                case 5: {
                    ...
                    if (podM == 1) {//Pregled poslovode OK
                        TextTable t('-', '|', '+');
                    ...
                    else if (podM == 2) {//Unos poslovode OK
                ...
                case 6: {
                    ...
                    cout << endl << "1. Poslovnica Nintendo" << endl; //ok
                    ...
                    if (podM == 1){// Poslovnica Nintendo
                        ...
                        if (submenu == 1) {//Provjera stanja
                        ...
                        else if (submenu == 2){//Ukupni visak proizvoda
                            SACommand comTmp;
                            comTmp.setConnection(&con);
                            ...
                            cout << "Visak proizvoda za poslovnicu Nintendo: " << (const char *) comTmp[1].asString() << endl << endl;
                        }
                        if (submenu == 3){//Broj proizvoda
                            SACommand comTmp;
                            comTmp.setConnection(&con);
                            ...
                            comTmp.Execute();
                            comTmp.FetchNext();
                            cout << "Kolicina proizvoda Nintendo: " << (const char *) comTmp[1].asString() << endl << endl;
                        }
                        if (submenu == 4){//Broj dostupnih proizvoda
                            SACommand comTmp;
                            comTmp.setConnection(&con);
                            ...
                            comTmp.Execute();
                            comTmp.FetchNext();
                            cout << "Dostupno proizvoda Nintendo: " << (const char *) comTmp[1].asString() << endl << endl;
                        }
                    }
                    if (podM == 2){
                        int submenu;
                        ...
                        if (submenu == 1) {//Provjera stanja OK
                            TextTable t('-', '|', '+');
                        ...
                        if (submenu == 2) {//Ukupni visak proizvoda
                            SACommand comTmp;
                            comTmp.setConnection(&con);
                            ...
                            cout << "Visak proizvoda za poslovnicu PS4: "
                                 << (const char *) comTmp[1].asString() << endl << endl;
                        }
                        if (submenu == 3) {//Broj proizvoda
                            SACommand comTmp;
                            comTmp.setConnection(&con);
                ...
                case 7: {
                    ...
                    if (podM == 1) {//Pregled racuna OK
                        ...
                        cout << endl << "Kolicina: ";
                        cin >> Kolicina;
                        cout << endl << "Posudeno Prodano : ";
                        cin >> Posudeno_Prodano;
                        cout << endl << "Datum placanja: ";
                        cin >> Datum_placanja;
                    ...
                    else if (podM == 4) {//Promet u mjesecu
                        TextTable tmp('-', '|', '+');
                        string mjesec;
                ...
                case 8: {
                    ...
                    if (podM == 1) {//Adrese
                        ...
                        else if (m1 == 3){ //Brisanje Adrese OK
                            string ID;
                    ...
                    if (podM == 2) {//Narudzbenice
                        ...
                        if (m1 == 1){ //Pregled narudzbenica OK
                            TextTable t('-', '|', '+');
                            ...
                            cout << endl << "~ ~ ~ Pregled Narudzbenica ~ ~ ~" << endl;
                        ...
                        else if (m1 == 2){ //Unos Narudzbenice OK
                        ...
                        else if (m1 == 3){ //Brisanje Narudzbenice OK
                            string ID;
                    ...
                    if (podM == 3) {//Posudeno OK
                        ...
                        if (m1 == 1){ //Pregled posudenog
                            ...
                            cout << endl << "~ ~ ~ Pregled Posudenog ~ ~ ~" << endl;
                            t.add("ID posudenog");
                            t.add("ID proizvoda");
                            t.add("ID racuna");
                            t.add("Datum posudbe");
                        ...
                        else if (m1 == 2){ //Unos Posudenog OK
                            ...
                            cout << endl << "ID racuna: ";
                            cin >> RacunID;
                            cout << endl << "Datum posudbe: ";
                            cin >> datum_posudbe;
                            cout << "Datum roka: ";
                            cin >> datum_roka;
                            cout << endl << "Cijena posudbe: ";
                            cin >> cijena_posudbe;
                            cout << endl << "ID poslovnice: ";
                            cin >> poslovnicaid;
                            cout << endl << "Datum posudbe: ";
                        ...
                        else if (m1 == 3){ //Brisanje Posudenog OK
                            string ID;
                    ...
                    if (podM == 4) {//Prodano
                        ...
                        if (m1 == 1){ //Pregled prodanog OK
                            ...
                            cout << endl << "~ ~ ~ Pregled Prodanog ~ ~ ~" << endl;
                            t.add("ID prodanog");
                            t.add("ID proizvoda");
                            t.add("ID racuna");
                            t.add("Kolicina");
                    ...
                    if (podM == 5) {//Rezije
                        ...
                        else if (m1 == 3){ //Brisanje rezije OK
                            string ID;
                        ...
                        else if (m1 == 4){//Mjesecne rezije OK
                            TextTable t('-', '|', '+');
                            int pID;
                            string mjs, god;
